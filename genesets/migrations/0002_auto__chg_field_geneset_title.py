...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Geneset.title'
        db.alter_column(u'genesets_geneset', 'title', self.gf('django.db.models.fields.CharField')(max_length=125))

    def backwards(self, orm):

        # Changing field 'Geneset.title'
        db.alter_column(u'genesets_geneset', 'title', self.gf('django.db.models.fields.CharField')(max_length=75))
