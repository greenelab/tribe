...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Geneset.tip_item_count'
        db.add_column(u'genesets_geneset', 'tip_item_count',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Geneset.tip_item_count'
        db.delete_column(u'genesets_geneset', 'tip_item_count')
    ...
    models = {
        ...
        u'genesets.geneset': {
            ...
            'tip_item_count': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
