...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'versions_version', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('gene_set', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['genesets.Geneset'])),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('ver_hash', self.gf('django.db.models.fields.CharField')(max_length=40, null=True)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True)),
            ('organism', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['organisms.Organism'])),
            ('commit_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['versions.Version'], null=True)),
            ('public', self.gf('django.db.models.fields.BooleanField')()),
            ('annotations', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'versions_version')
    ...
    models = {
        ...
        u'versions.version': {
            'Meta': {'ordering': "['gene_set', 'commit_date']", 'unique_together': "(('gene_set', 'ver_hash'),)", 'object_name': 'Version'},
            ...
            'gene_set': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['genesets.Geneset']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'organism': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['organisms.Organism']"}),
