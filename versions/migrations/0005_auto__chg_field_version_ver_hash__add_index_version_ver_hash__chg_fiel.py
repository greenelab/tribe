...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Version.ver_hash'
        db.alter_column(u'versions_version', 'ver_hash', self.gf('django.db.models.fields.CharField')(default='set during migration', max_length=40))
        # Adding index on 'Version', fields ['ver_hash']
        db.create_index(u'versions_version', ['ver_hash'])


        # Changing field 'Version.annotations'
        db.alter_column(u'versions_version', 'annotations', self.gf('django.db.models.fields.TextField')(default=frozenset([])))

    def backwards(self, orm):
        # Removing index on 'Version', fields ['ver_hash']
        db.delete_index(u'versions_version', ['ver_hash'])


        # Changing field 'Version.ver_hash'
        db.alter_column(u'versions_version', 'ver_hash', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))

        # Changing field 'Version.annotations'
        db.alter_column(u'versions_version', 'annotations', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        u'versions.version': {
            ...
            'annotations': ('django.db.models.fields.TextField', [], {}),
            ...
            'ver_hash': ('django.db.models.fields.CharField', [], {'max_length': '40', 'db_index': 'True'})
        }
    }
