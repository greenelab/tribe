...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Version.organism'
        db.delete_column(u'versions_version', 'organism_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Version.organism'
        raise RuntimeError("Cannot reverse this migration. 'Version.organism' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Version.organism'
        db.add_column(u'versions_version', 'organism',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['organisms.Organism']),
                      keep_default=False)
