...
python manage.py organisms_create_or_update --taxonomy_id=208964 --scientific_name="Pseudomonas aeruginosa" --common_name="Pseudomonas aeruginosa"
...
python manage.py genes_add_xrdb --name=PseudoCAP --URL=http://www.pseudomonas.com/getAnnotation.do?locusID=_REPL_
...
#PSEUDOMONAS
wget -P data/ -N ftp://ftp.ncbi.nih.gov/gene/DATA/GENE_INFO/Archaea_Bacteria/Pseudomonas_aeruginosa_PAO1.gene_info.gz
gunzip -c data/Pseudomonas_aeruginosa_PAO1.gene_info.gz > data/Pseudomonas_aeruginosa_PAO1.gene_info
python manage.py genes_load_geneinfo --geneinfo_file=data/Pseudomonas_aeruginosa_PAO1.gene_info --taxonomy_id=208964 --systematic_col=3 --symbol_col=2 --put_systematic_in_xrdb=PseudoCAP

#FLY
wget -P data/ -N ftp://ftp.ncbi.nih.gov/gene/DATA/GENE_INFO/Invertebrates/Drosophila_melanogaster.gene_info.gz
gunzip -c data/Drosophila_melanogaster.gene_info.gz > data/Drosophila_melanogaster.gene_info
python manage.py genes_load_geneinfo --geneinfo_file=data/Drosophila_melanogaster.gene_info --taxonomy_id=7227 --systematic_col=3 --symbol_col=2

#ARABIDOPSIS
wget -P data/ -N ftp://ftp.ncbi.nih.gov/gene/DATA/GENE_INFO/Plants/Arabidopsis_thaliana.gene_info.gz
gunzip -c data/Arabidopsis_thaliana.gene_info.gz > data/Arabidopsis_thaliana.gene_info
python manage.py genes_load_geneinfo --geneinfo_file=data/Arabidopsis_thaliana.gene_info --taxonomy_id=3702 --systematic_col=3 --symbol_col=2
...
python manage.py genesets_load_go --organism="Homo sapiens" --evidence="EXP,IDA,IPI,IMP,IGI,IEP" --user=tribeupdater --remote --initial
python manage.py genesets_load_go --organism="Mus musculus" --evidence="EXP,IDA,IPI,IMP,IGI,IEP" --user=tribeupdater --remote --initial --leading
python manage.py genesets_load_go --organism="Danio rerio" --evidence="EXP,IDA,IPI,IMP,IGI,IEP" --user=tribeupdater --remote --initial
python manage.py genesets_load_go --organism="Rattus norvegicus" --evidence="EXP,IDA,IPI,IMP,IGI,IEP" --user=tribeupdater --remote --initial
python manage.py genesets_load_go --organism="Saccharomyces cerevisiae" --evidence="EXP,IDA,IPI,IMP,IGI,IEP" --user=tribeupdater --remote --initial
python manage.py genesets_load_go --organism="Caenorhabditis elegans" --evidence="EXP,IDA,IPI,IMP,IGI,IEP" --user=tribeupdater --remote --initial
python manage.py genesets_load_go --organism="Pseudomonas aeruginosa" --evidence="EXP,IDA,IPI,IMP,IGI,IEP" --user=tribeupdater --remote --initial --pseudomonas
python manage.py genesets_load_go --organism="Drosophila melanogaster" --evidence="EXP,IDA,IPI,IMP,IGI,IEP" --user=tribeupdater --remote --initial
python manage.py genesets_load_go --organism="Arabidopsis thaliana" --evidence="EXP,IDA,IPI,IMP,IGI,IEP" --user=tribeupdater --remote --initial --tair
...
python manage.py genesets_load_kegg --organism="Pseudomonas aeruginosa" --user=tribeupdater --gene_id=systematic_name --kegg_record_types="Pathway, Module"
